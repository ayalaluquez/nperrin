module.exports = {
  siteMetadata: {
    baseTitle: 'Tech blog',
    title: 'Norman Perrin',
    description: 'Tech blog of Norman Perrin.',
    author: '@NormanPerrinOK',
    keywords: 'tech blog, programmer, programador, systems, sistemas, norman, perrin, nperrin, comunidadit, utn, argentina',
    host: 'https://blog.nperrin.io/',
    ...
    source: 'https://github.com/NormanPerrin/nperrin/tree/blog/',
    excludedLinks: [
      '/dev-404-page/',
      '/404/',
      '/credits/',
